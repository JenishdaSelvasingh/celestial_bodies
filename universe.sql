...
--
-- Name: galaxy galaxy_sid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.galaxy
    ADD CONSTRAINT galaxy_sid_fkey FOREIGN KEY (star_id) REFERENCES public.star(star_id);
...
--
-- Name: planet planet_mid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.planet
    ADD CONSTRAINT planet_mid_fkey FOREIGN KEY (moon_id) REFERENCES public.moon(moon_id);
...
--
-- Name: star star_pid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.star
    ADD CONSTRAINT star_pid_fkey FOREIGN KEY (planet_id) REFERENCES public.planet(planet_id);
